...
export default function CaCertificatesGuidePage() {
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2"><Award /> CA Certificate Generator</CardTitle>
        </CardHeader>
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <ol>
            ...
            <li><strong>Preview Draft:</strong> After entering the data, the system generates a formatted, live preview of the certificate with all the standard legal wording. You can review this draft for accuracy.</li>
            <li><strong>Share & Download:</strong> You can immediately print the draft, save it as a PDF, or share it with your client for review via WhatsApp and other platforms.</li>
            <li><strong>Request Certification (for Professionals):</strong> Once the draft is finalized, you can use the "Request Certification" feature. This sends the document to the admin panel, creating a formal record and allowing a senior partner or authorized person to digitally sign (DSC) the document offline and upload the final, certified copy for the client.</li>
          </ul>

          <h4 className="flex items-center gap-2 mt-6"><FileSignature/> Certification Workflow</h4>
          <p>The "Request Certification" button is a key part of the professional workflow. It creates a formal audit trail by logging the request in the Admin panel under "Certification Requests". This allows a firm to manage the final signing and delivery process securely and efficiently.</p>
        </CardContent>
         <CardFooter>
