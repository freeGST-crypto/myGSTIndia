    ...
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <Card>
        ...
        <CardContent className="prose dark:prose-invert max-w-none">
          ...
          <Image src="https://picsum.photos/seed/dashboard-guide/800/400" alt="Dashboard Screenshot" width={800} height={400} className="rounded-lg border" data-ai-hint="dashboard analytics" />

          <h3>Key Panels</h3>
          <p>The dashboard is divided into several key panels:</p>

          <h4 className="flex items-center gap-2"><IndianRupee /> Stat Cards</h4>
          ...
          <h4 className="flex items-center gap-2"><BarChart3 /> Financial Summary Chart</h4>
          ...
          <h4 className="flex items-center gap-2"><CalendarDays /> Compliance Calendar</h4>
          <p>Located on the right side, this panel shows upcoming statutory compliance deadlines, such as GSTR-1 and GSTR-3B filing dates. It helps you stay on top of your tax obligations and avoid late fees.</p>
           ...
           <h4 className="flex items-center gap-2"><Keyboard /> Quick Access & Shortcuts</h4>
          <p>This panel provides quick links and keyboard shortcuts to the most frequently used actions, like creating a new invoice or viewing financial reports. Using these shortcuts can significantly speed up your workflow. You can view all shortcuts by navigating to <strong>Resources {'>'} App Shortcuts</strong>.</p>
        </CardContent>
      </Card>
    </div>
  );
