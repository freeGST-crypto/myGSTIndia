...
const samplePurchaseOrders = [
    { id: "PO-001", vendor: "Supplier Inc.", date: "2024-07-01", amount: 80000, status: "Open" },
    { id: "PO-002", vendor: "Component Solutions", date: "2024-06-28", amount: 125000, status: "Billed" },
    { id: "PO-003", vendor: "Raw Materials Co.", date: "2024-06-25", amount: 350000, status: "Closed" },
];
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Create, manage, and track your purchase orders to vendors.
          </p>
        </div>
       ...
       <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <StatCard title="Open POs" value="1" icon={Package} description="₹80,000.00" />
        <StatCard title="POs Billed" value="1" icon={FileText} description="₹1,25,000.00" />
        <StatCard title="Received (30d)" value="8" icon={CheckCircle} description="Total POs closed recently" />
      </div>
